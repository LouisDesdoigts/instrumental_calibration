...
High-precision, high-cadence time series of space photometry from \textit{Kepler} \cite{Borucki2010}, K2 \cite{K2}, TESS \cite{TESS} and CHEOPS \cite{CHEOPS} space telescopes have been revolutionary for exoplanetary science and stellar asr. This increased precision over that last 20 years has also revolutionized asteroseismology [cite multiple papers here], the study of stellar interiors. 
