...
In each case, we face serious limitations from an imperfect knowledge of the \ac{prf} -- the map of the intra-pixel and inter-pixel variations in detector sensitivity; and also of the \ac{psf} -- the diffraction-limited pattern by which light from a point source like a starspreads across a detector.
...
\begin{figure*}
    ...
    \script{plot_gen_astro_params.py}
\end{figure*}

\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{figs/aberrations.pdf}
